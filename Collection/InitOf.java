...
public class InitOf {
  public static void main(String[] args) {
    ...
    ArrayList<String> arraylist2 = new ArrayList<>(List.of(colors));
    System.out.println("arraylist2: "+arraylist2);
    HashSet<String> hashset1 = new HashSet<>(Set.of("Yellow","Orange","Black"));
    System.out.println("hashset1: "+hashset1);
    Integer[] nums = {2,4,3,6,1,5,7};
    HashSet<Integer> hashset2 = new HashSet<>(Set.of(nums));
